...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def retranslateUi(self):
        ...
        self.actionViewerToolbar.setText(
            _translate("MainWindow", "Create Filter "))
        self.actionViewerToolbar.setToolTip(
            _translate("MainWindow", "Creates a fitler "))
        self.actionViewerToolbar.setShortcut(
            _translate("MainWindow", "Ctrl+Alt+F"))
        self.actionView_Statistics.setText(
            _translate("MainWindow", "View Statistics"))
        self.actionView_Statistics.setToolTip(
            _translate("MainWindow", "Show dataset statistics"))
        self.actionView_Statistics.setShortcut(
            _translate("MainWindow", "Ctrl+Alt+S"))
        self.actionSave_Model.setText(_translate("MainWindow", "Save Model"))
        self.actionDataset_Viewer.setText(
            _translate("MainWindow", "Dataset Viewer"))
